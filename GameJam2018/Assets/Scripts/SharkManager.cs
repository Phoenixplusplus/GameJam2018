...
public class SharkManager : MonoBehaviour {
    ...
    void Start () {
        ...
        for (int i = 0; i < SharkCount; i++)
        {
            ...
            Transform MyShark = Instantiate(shark, new Vector3(Mathf.Cos(SpawnAngle) * Random.Range(0, Spawnradius), SpawnHeight, Mathf.Sin(SpawnAngle) * Random.Range(0, Spawnradius)), Quaternion.identity);
